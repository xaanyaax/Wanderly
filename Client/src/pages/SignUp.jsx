  ...
  return (
    <div className="min-h-screen bg-black relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-40 right-32 w-24 h-24 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-full blur-lg animate-bounce"
          style={{ animationDuration: "3s" }}
        ></div>
        <div
          className="absolute bottom-32 left-40 w-40 h-40 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 rounded-full blur-2xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-20 right-20 w-28 h-28 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full blur-xl animate-bounce"
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/3 w-1.5 h-1.5 bg-pink-400 rounded-full animate-ping"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/3 w-1 h-1 bg-blue-400 rounded-full animate-ping"
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-0 right-1/2 w-80 h-80 bg-cyan-600/10 rounded-full blur-3xl animate-pulse transform translate-x-1/2"
          style={{ animationDelay: "2s" }}
        ></div>
      </div>
        ...
        <div className="bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-700/50 p-6 transform hover:scale-105 transition-all duration-300 relative overflow-hidden">
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="relative">
              ...
              />
              <div
                className={`absolute left-4 top-0 -translate-y-1/2 px-2 bg-gradient-to-r from-purple-500 to-cyan-500 text-white text-sm rounded-full transition-all duration-300 ${
