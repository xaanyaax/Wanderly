      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-6 transform hover:scale-105 transition-all duration-300">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/70 text-sm">Join us and get started</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <div className={`absolute left-4 top-0 -translate-y-1/2 px-2 bg-gradient-to-r from-purple-500 to-blue-500 text-white text-sm rounded-full transition-all duration-300 ${focusedField === 'username' || formData.username ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
                Username
              </div>
            </div>
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <div className={`absolute left-4 top-0 -translate-y-1/2 px-2 bg-gradient-to-r from-purple-500 to-blue-500 text-white text-sm rounded-full transition-all duration-300 ${focusedField === 'phoneNumber' || formData.phoneNumber ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
                Phone
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className={`absolute left-4 top-0 -translate-y-1/2 px-2 bg-gradient-to-r from-purple-500 to-blue-500 text-white text-sm rounded-full transition-all duration-300 ${focusedField === 'confirmPassword' || formData.confirmPassword ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
                Confirm Password
              </div>
            </div>
